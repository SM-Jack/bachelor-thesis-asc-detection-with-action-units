...
def DISFA_infolist(list):
    ...
    infostr = {'AU1: {:.2f} AU2: {:.2f} AU4: {:.2f}  AU6: {:.2f} AU9: {:.2f} AU12: {:.2f}  AU25: {:.2f} AU26: {:.2f} '.format(*[100.*x for x in list])}
...
def hybrid_named_prediction_infolist(pred, thresh):
...
def create_hybrid_dictionary(pred):
    infodic_probs = "'AU1': {:.2f}, 'AU2': {:.2f}, 'AU4': {:.2f}, 'AU5': {:.2f}, 'AU6': {:.2f}, 'AU7': {:.2f}, 'AU9': {:.2f}, 'AU10': {:.2f}, 'AU11': {:.2f}, 'AU12': {:.2f}, 'AU13': {:.2f}, 'AU14': {:.2f}, 'AU15': {:.2f}, 'AU16': {:.2f}, 'AU17': {:.2f}, 'AU18': {:.2f}, 'AU19': {:.2f}, 'AU20': {:.2f}, 'AU22': {:.2f}, 'AU23': {:.2f}, 'AU24': {:.2f}, 'AU25': {:.2f}, 'AU26': {:.2f}, 'AU27': {:.2f}, 'AU32': {:.2f}, 'AU38': {:.2f}, 'AU39': {:.2f}, 'AUL1': {:.2f}, 'AUR1': {:.2f}, 'AUL2': {:.2f}, 'AUR2': {:.2f}, 'AUL4': {:.2f}, 'AUR4': {:.2f}, 'AUL6': {:.2f}, 'AUR6': {:.2f}, 'AUL10': {:.2f}, 'AUR10': {:.2f}, 'AUL12': {:.2f}, 'AUR12': {:.2f}, 'AUL14': {:.2f}, 'AUR14': {:.2f}".format(*[100.*x for x in pred])
    return infodic_probs
...
def hybrid_prediction_infolist(pred, thresh):
    ...
    AU_lists = ["AU1", #'Inner brow raiser',
        ...
        "AUL1",#'Left Inner brow raiser',
        "AUR1",#'Right Inner brow raiser',
        "AUL2",#'Left Outer brow raiser',
        "AUR2",#'Right Outer brow raiser',
        "AUL4",#'Left Brow lowerer',
        "AUR4",#'Right Brow lowerer',
        "AUL6",#'Left Cheek raiser',
        "AUR6",#'Right Cheek raiser',
        "AUL10",#'Left Upper lip raiser',
        "AUR10",#'Right Upper lip raiser',
        "AUL12",#'Left Nasolabial deepener',
        "AUR12",#'Right Nasolabial deepener',
        "AUL14",#'Left Dimpler',
        "AUR14"#'Right Dimpler']
        ]

    AU_indexs = np.where(pred>=thresh)[0]
    AU_prediction = [AU_lists[i] for i in AU_indexs]
    infostr_au_pred = {*AU_prediction}
    return infostr_pred_probs, infostr_au_pred
...
class WeightedAsymmetricLoss(nn.Module):
    def __init__(self, eps=1e-8, disable_torch_grad=True, weight=None, size_average=None, reduce=None, reduction='mean'):

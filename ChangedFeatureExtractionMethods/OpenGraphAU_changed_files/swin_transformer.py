...
model_name = {
    ...
    'swin_transformer_base': 'OpenGprahAU-SwinB_second_stage.pth' #'swin_base_patch4_window7_224.pth',
}
...
def swin_transformer_base(pretrained=True, **kwargs):
    ...
    if pretrained:
        path = os.path.join(models_dir, model_name['swin_transformer_base'])
